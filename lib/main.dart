...
import 'package:climbingfrontend/firebase_options.dart';
import 'package:climbingfrontend/views/ui/auth/login.dart';
import 'package:climbingfrontend/views/ui/mainscreen.dart';
import 'package:climbingfrontend/views/ui/onboarding/onboarding_screen.dart';
...
void main() async {
  ...
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider(create: (context) => RoadsNotifier()),
